...
const Campaigns: React.FC = () => {
  ...
  // Mostrar filtros sempre, mesmo sem campanhas
    return (
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 space-y-3 sm:space-y-0">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`flex items-center space-x-2 px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl font-medium transition-all duration-300 text-sm sm:text-base ${
              activeTab === 'campaigns'
      ...
      >
        <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 -mx-4 sm:mx-0">
          {loading ? (
