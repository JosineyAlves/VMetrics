          ...
          <div className="flex items-center gap-3">
            ...
            {showRefresh && (
              <button 
                ...
                className="inline-flex items-center px-4 py-2 rounded-xl border border-[#6366f1] text-[#6366f1] font-semibold hover:bg-[#6366f1]/10 transition disabled:opacity-50"
              >
