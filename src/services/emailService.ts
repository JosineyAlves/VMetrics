...
// Função para enviar email genérico
export async function sendEmail(emailData: EmailData): Promise<{ success: boolean; message: string; data?: any }> {
  try {
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <h2>Olá \!</h2>
            <p>Parabéns! Você acabou de adquirir o plano <span class='plan-badge'>\</span> no VMetrics.</p>
            <p>Para começar a usar sua plataforma, você precisa criar sua conta:</p>
            <div style='text-align: center;'>
                <a href='\' class='cta-button'>🚀 Criar Minha Conta</a>
            </div>
