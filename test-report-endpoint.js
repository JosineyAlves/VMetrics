// Teste do endpoint /report para verificar dados agregados
...
async function testReportEndpoint() {
  console.log('=== TESTE DO ENDPOINT /REPORT ===');
  ...
  reportUrl.searchParams.set('metrics', 'clicks,conversions,cost,revenue,unique_clicks');
  ...
  try {
    ...
    if (data.data && Array.isArray(data.data)) {
      ...
      data.data.forEach((item, index) => {
        ...
        console.log(`  - Unique Clicks: ${item.unique_clicks}`);
