...
const FunnelChart: React.FC<FunnelChartProps> = ({ data }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-white/20 hover:shadow-3xl transition-all duration-500 h-full flex flex-col"
    >
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-gray-500">
        <div className="flex items-center space-x-1">
          ...
          <span className="truncate">Pre-LP</span>
        </div>
        <div className="flex items-center space-x-1">
